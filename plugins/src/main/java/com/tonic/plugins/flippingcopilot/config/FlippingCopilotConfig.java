package com.tonic.plugins.flippingcopilot.config;
...
public interface FlippingCopilotConfig extends Config
{
    ...
    @ConfigItem(
            keyName = "useLocalOsrsWikiPrices",
            name = "Use local OSRS Wiki prices",
            description = "Use the OSRS Wiki price API for suggestions instead of the server. Enables basic flipping suggestions without authentication.",
            position = 6
    )
    default boolean useLocalOsrsWikiPrices()
    {
        return false;
    }
