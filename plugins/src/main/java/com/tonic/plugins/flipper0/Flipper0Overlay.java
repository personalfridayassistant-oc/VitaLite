...
public class Flipper0Overlay extends Overlay
{
    private final Flipper0Plugin plugin;
    private final ItemManager itemManager;

    @Inject
    public Flipper0Overlay(Flipper0Plugin plugin, ItemManager itemManager)
    {
        this.plugin = plugin;
    ...
    public Dimension render(Graphics2D graphics)
    {
        ...
        graphics.drawString("Flipper0", x + 10, y + 18);
    ...
    private void drawSuggestionBlock(Graphics2D graphics, int x, int y, String title, Flipper0Plugin.Suggestion s)
    {
