...
public class FlipperOnePanel extends PluginPanel
{
    ...
    @Inject
    public FlipperOnePanel(ItemManager itemManager)
    {
    ...
    public void refresh(String status, String coins, String slots, String gpPerHour, String apiStatus, String debugInfo,
                        FlipperOnePlugin.Suggestion current, List<FlipperOnePlugin.Suggestion> top, Actions actions)
    {
    ...
    private JPanel buildSuggestionRow(FlipperOnePlugin.Suggestion s, int rank)
    {
